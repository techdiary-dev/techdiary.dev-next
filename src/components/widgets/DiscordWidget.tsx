...
const DiscordWidget = () => {
  ...
  return (
    <div className="p-3 overflow-hidden border app-border-color rounded-lg">
      <a
      ...
      >
        <svg
          className="w-auto h-12 fill-current text-primary"
        ...
        <div className="block px-3 pt-1 pb-3 mt-1 text-sm text-foreground-muted">
          <strong className="block font-mono">Techdiary Discord</strong>
          <span className="block pt-2 pb-1 text-sm text-forground-muted">
