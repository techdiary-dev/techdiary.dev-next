...
const DiscordWidget = () => {
  return (
    <div className="p-3 overflow-hidden border border-gray-200 rounded-lg dark:border-gray-600">
      <a
      ...
      >
        <svg
          className="w-auto h-12 fill-current theme-text"
        ...
        <span className="block px-3 pt-1 pb-3 mt-1 text-sm text-gray-700 dark:text-gray-200">
          <strong className="block font-mono">Techdiary Discord</strong>
          <span className="block pt-2 pb-1 text-sm text-gray-600 dark:text-gray-300">
